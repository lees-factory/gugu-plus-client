...
<div class="space-y-10 p-6 sm:p-8 lg:p-10">
	...
	{:else if !auth.user}
		<div class="flex flex-col items-center justify-center gap-6 py-24 text-center">
			<div
				class="flex size-16 items-center justify-center rounded-3xl bg-zinc-100/80 border border-zinc-200/60 shadow-sm"
			>
				<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="size-8 text-zinc-400" aria-hidden="true">
	...
	{:else}
		...
		>
			<div class="relative max-w-md flex-1">
				<svg
					...
					stroke="currentColor"
					stroke-width="2"
					class="pointer-events-none absolute left-4 top-1/2 size-[18px] -translate-y-1/2 text-zinc-400"
					aria-hidden="true"
				>
			...
			<div class="flex items-center gap-3">
				...
				>
					<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="mr-2 size-4" aria-hidden="true">
				...
				<div class="grid gap-6 md:grid-cols-2">
					<div>
						<label
							...
							class="text-[9px] font-semibold uppercase tracking-wider text-zinc-400"
						>
					...
					<div>
						<label for="items-sort" class="text-[9px] font-semibold uppercase tracking-wider text-zinc-400">
							{t('items_filter_sort')}
						</label>
						<select
							id="items-sort"
		...
		{:else}
			...
			<div
				class="flex items-center justify-between rounded-3xl border border-zinc-200/60 bg-white/60 p-5 backdrop-blur-sm shadow-sm"
			>
				<div class="flex items-center gap-4">
					<div class="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-white border border-zinc-200/60 shadow-sm">
			...
			<div
				class="mb-2 hidden items-center border-b border-zinc-200/60 px-4 py-2 text-[9px] font-semibold uppercase tracking-wider text-zinc-400 md:flex"
			>
