...
>
	<div class="flex items-center gap-3">
		...
		<div>
			<h1 class="text-2xl font-semibold sm:text-3xl" style="color: #1a1a17; letter-spacing: -0.02em;">개인정보처리방침</h1>
	...
	<div class="mx-auto max-w-2xl">
		<div class="rounded-2xl bg-white p-7 sm:p-8" style="border: 1px solid rgba(45, 45, 42, 0.06);">
			...
			{#each [
				{
					title: '제1조 (수집하는 개인정보)',
					body: '서비스 이용 과정에서 다음과 같은 정보가 수집됩니다.\n\n• 필수: 이메일 주소 (회원 식별 및 알림 발송)\n• 자동 수집: 서비스 이용 기록, 접속 IP, 브라우저 유형 (서비스 품질 개선 목적)\n• 결제 시: 결제 수단 정보 (PG사를 통해 처리되며, 당사는 카드 번호 전체를 저장하지 않습니다)\n\n비밀번호는 단방향 암호화(bcrypt)로 저장되며, 운영자도 복호화할 수 없습니다.'
				},
				{
				...
				},
				{
					...
					body: '서비스는 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 단, 다음의 경우는 예외로 합니다.\n\n• 이용자가 사전에 동의한 경우\n• 법령의 규정에 의거하거나 수사 목적으로 관계 기관이 요구하는 경우\n• 결제 처리를 위해 PG사(결제 대행사)에 최소한의 정보를 제공하는 경우'
				},
				{
					title: '제5조 (쿠키 사용)',
					body: '서비스는 로그인 세션 유지를 위해 쿠키를 사용합니다. 쿠키에는 개인을 직접 식별할 수 있는 정보(이름, 주민번호 등)는 포함되지 않습니다. 브라우저 설정을 통해 쿠키 저장을 거부할 수 있으나, 이 경우 로그인 상태 유지 등 일부 서비스 이용이 제한될 수 있습니다.'
				},
				{
					title: '제6조 (이용자 권리)',
				...
				},
				{
					...
					body: '서비스는 개인정보 보호를 위해 다음과 같은 기술적·관리적 조치를 시행합니다.\n\n• 모든 통신 구간 SSL/TLS 암호화\n• 비밀번호 bcrypt 단방향 암호화 저장\n• 접근 권한 최소화 및 정기 검토\n• 개인정보 처리 내역 정기 점검'
				},
				{
