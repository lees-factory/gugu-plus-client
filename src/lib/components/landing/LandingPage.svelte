...
<div class="min-h-svh bg-[#F5F4F1]">
	<!-- Landing Nav -->
	<nav class="sticky top-0 z-50 flex items-center justify-between bg-[#F5F4F1]/80 px-5 py-4 backdrop-blur-sm sm:px-8">
		...
		<div class="flex items-center gap-3">
			...
			<div class="relative">
				...
				{#if langOpen}
					...
					></div>
					<div class="absolute right-0 z-50 mt-2 w-36 overflow-hidden rounded-2xl border border-zinc-200/60 bg-white shadow-xl">
						<button
							type="button"
						...
						>
							한국어
							{#if currentLocale === 'ko'}
								<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="size-3.5 text-zinc-700" aria-hidden="true">
