	...
	>
		<div class="flex min-w-0 flex-1 items-start gap-4 md:items-center md:gap-4 md:pr-4">
			...
			>
				...
				{:else}
					<div class="flex size-full items-center justify-center">
						<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="size-6 text-zinc-400" aria-hidden="true">
			...
			<div class="min-w-0 flex-1">
				<h3
					class="line-clamp-2 text-sm font-semibold leading-snug text-zinc-900 transition-colors group-hover:text-stone-800 md:line-clamp-1"
				>
					{item.title}
				</h3>
				<div class="mt-1.5 flex items-center gap-2">
					<span
						class="rounded-lg border border-zinc-200/60 bg-zinc-50/80 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-zinc-600"
					>
						{item.site}
					</span>
				</div>
		...
		>
			<div class="flex justify-between gap-4 md:contents">
				<div class="flex flex-col md:w-20">
					<span class="mb-1 text-[10px] font-semibold uppercase tracking-wider text-zinc-400 md:hidden"
						>{t('items_col_current')}</span
					>
					<span class="text-2xl font-semibold leading-none text-zinc-900 md:text-sm">
				...
				<div class="flex flex-col text-right md:w-20 md:text-left">
					...
					>
					<span class="text-xl font-medium leading-none text-zinc-600 md:text-sm">
			...
			<div class="hidden w-24 flex-col justify-center gap-2 md:flex">
				<div class="flex justify-between text-[9px] font-semibold uppercase leading-none tracking-wider text-zinc-400">
			...
			<div class="md:hidden">
				<span class="mb-1 block text-[10px] font-semibold uppercase tracking-wider text-zinc-400"
